...
| 最该先防什么风险 | [Security First](security-first.md) |
| 配置应该怎么想 | [How To Think About Configuration](configuration.md) |
...
3. [Security First](security-first.md)
4. [How To Think About Configuration](configuration.md)
...
- [How To Think About Configuration](configuration.md)
...
- 正在做配置和集成：重点看 `Configuration` 和 `API Selection`
